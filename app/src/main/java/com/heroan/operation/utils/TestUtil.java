...
public class TestUtil {
    ...
    public static List<RtuItem> getUserList() {
     ...
     * @return
     */
    public static List<RtuItem> getUserList(int page) {
     ...
     * @return
     */
    public static List<RtuItem> getUserList(int page, int count) {
        List<RtuItem> list = new ArrayList<RtuItem>();
        long userId;
        RtuItem user;
