...
import com.heroan.operation.utils.JPushUtil;
...
public class TagAliasOperatorHelper {
    ...
    private boolean RetryActionIfNeeded(int errorCode, TagAliasBean tagAliasBean) {
        ...
        if (errorCode == 6002 || errorCode == 6014) {
            ...
            if (tagAliasBean != null) {
                ...
                String logs = getRetryStr(tagAliasBean.isAliasAction, tagAliasBean.action,
                        errorCode);
    ...
    private boolean RetrySetMObileNumberActionIfNeeded(int errorCode, String mobileNumber) {
        ...
        if (errorCode == 6002 || errorCode == 6024) {
            ...
            str = String.format(Locale.ENGLISH, str, (errorCode == 6002 ? "timeout" : "server " +
                    "internal error”"));
    ...
    private String getRetryStr(boolean isAliasAction, int actionType, int errorCode) {
        ...
        str = String.format(Locale.ENGLISH, str, getActionStr(actionType), (isAliasAction ?
                "alias" : " tags"), (errorCode == 6002 ? "timeout" : "server too busy"));
        return str;
    }
    ...
    public void onCheckTagOperatorResult(Context context, JPushMessage jPushMessage) {
        ...
        if (jPushMessage.getErrorCode() == 0) {
            ...
            setActionCache.remove(sequence);
            String logs =
                    getActionStr(tagAliasBean.action) + " tag " + jPushMessage.getCheckTag() + " " +
    ...
    public void onMobileNumberOperatorResult(Context context, JPushMessage jPushMessage) {
        int sequence = jPushMessage.getSequence();
        Log.i(TAG, "action - onMobileNumberOperatorResult, sequence:" + sequence + ",mobileNumber" +
