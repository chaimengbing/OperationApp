...
public class LSysPamarsFragment extends BaseFragment implements View.OnClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        setContentView(R.layout.fragment_lsyspamars);
        initView();
        initData();
        initEvent();
        return view;
...
//                if (isIP(ip) == false)
//                {
//                    ToastUtil.showToastLong(getString(R.string.Configured_IP_parameters) + ip +
// getString(R.string.illegal));
//                }
