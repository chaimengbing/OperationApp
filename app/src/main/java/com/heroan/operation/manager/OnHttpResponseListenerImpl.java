...
package com.heroan.operation.manager;
...
public class OnHttpResponseListenerImpl implements OnHttpResponseListener
    ...
    public void onHttpResponse(int requestCode, String resultJson, Exception e) {
        ...
        try {
            ...
            resultState = jsonObject.getBoolean("state");//TODO code改为接口文档给的key
            resultData = jsonObject.getString("message");//TODO data改为接口文档给的key
        } catch (Exception e1) {
        ...
        if (resultState) {
            ...
            resultCode = 0;
            listener.onHttpError(requestCode, resultData);
        }
    }
    ...
    public void onHttpError(int requestCode, String resultData) {
        Log.i(TAG, "onHttpError  resultData = " + resultData);
    }
