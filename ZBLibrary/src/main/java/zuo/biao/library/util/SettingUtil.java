...
public final class SettingUtil {
    ...
    /**
     * TODO 改为你的正式服务器地址
     * http://47.99.189.101/vcontrolCloud
     * http://rtuyun.cn/registerAjax
     */
    public static final String URL_SERVER_ADDRESS_NORMAL_HTTP = "http://cloud.zjswxjs.com/";//正式服务器
    /**
     * TODO 改为你的正式服务器地址
     */
    public static final String URL_SERVER_ADDRESS_NORMAL_HTTPS = "http://cloud.zjswxjs.com/";//正式服务器
    /**
     ...
     * TODO 改为你的存图片的服务器地址
     */
    public static final String KEY_SET_MODE = "SET_MODE";

    public static final int KEY_SET_MODE_WIFI = 0;
    public static final int KEY_SET_MODE_BLE = 1;

    public static void setSetMode(int values) {
        SharedPreferences sdf = context.getSharedPreferences(APP_SETTING, Context.MODE_PRIVATE);
        sdf.edit().putInt(KEY_SET_MODE, values).commit();
