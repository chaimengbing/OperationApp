...
public class CommonUtil {
    ...
    public static void toMessageChat(Activity context, String phone) {
        if (context == null || StringUtil.isNotEmpty(phone, true) == false) {
            Log.e(TAG, "sendMessage  context == null || StringUtil.isNotEmpty(phone, true) == " +
					"false) >> return;");
            return;
        }
    ...
    public static void shareInfo(Activity context, String toShare) {
        if (context == null || StringUtil.isNotEmpty(toShare, true) == false) {
            Log.e(TAG, "shareInfo  context == null || StringUtil.isNotEmpty(toShare, true) == " +
					"false >> return;");
            return;
        }
    ...
    public static void sendEmail(Activity context, String emailAddress) {
        if (context == null || StringUtil.isNotEmpty(emailAddress, true) == false) {
            Log.e(TAG, "sendEmail  context == null || StringUtil.isNotEmpty(emailAddress, true) " +
					"== false >> return;");
            return;
        }
    ...
    public static void openWebSite(Activity context, String webSite) {
        if (context == null || StringUtil.isNotEmpty(webSite, true) == false) {
            Log.e(TAG, "openWebSite  context == null || StringUtil.isNotEmpty(webSite, true) == " +
					"false >> return;");
            return;
        }

        toActivity(context, new Intent(Intent.ACTION_VIEW,
				Uri.parse(StringUtil.getCorrectUrl(webSite))));
    }
    ...
    public static void copyText(Context context, String value) {
        if (context == null || StringUtil.isNotEmpty(value, true) == false) {
            Log.e(TAG, "copyText  context == null || StringUtil.isNotEmpty(value, true) == false " +
					">> return;");
            return;
        }
    ...
    public static void showProgressDialog(Activity context, int stringResId) {
        try {
            ...
            Log.e(TAG, "showProgressDialog  showProgressDialog(Context context, null, context" +
    ...
    /**
     * 快捷显示short toast方法，需要long toast就用 Toast.makeText(string, Toast.LENGTH_LONG).show();
	 * ---不常用所以这个类里不写
     *
     * @param context
     * @param string
    ...
    public static void showShortToast(final Context context, int stringResId) {
        try {
            ...
            Log.e(TAG, "showShortToast  context.getResources().getString(resId) >>  catch " +
     ...
     * @param photoBitmap
     */
    public static String savePhotoToSDCard(String path, String photoName, String formSuffix,
										   Bitmap photoBitmap) {
        if (photoBitmap == null || StringUtil.isNotEmpty(path, true) == false
            ...
            Log.e(TAG, "savePhotoToSDCard photoBitmap == null || StringUtil.isNotEmpty(path, " +
					"true) == false" +
